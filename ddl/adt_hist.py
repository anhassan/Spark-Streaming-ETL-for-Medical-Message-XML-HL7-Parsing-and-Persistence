...
dbutils.fs.rm('dbfs:/mnt/datalake/curated/epic_rltm/adt_hist',True)

# COMMAND ----------

# MAGIC %sql
# MAGIC drop table if exists epic_rltm.adt_hist;
# MAGIC create table epic_rltm.adt_hist(
...
# MAGIC   )
# MAGIC   USING DELTA
# MAGIC   LOCATION 'dbfs:/mnt/datalake/curated/epic_rltm/adt_hist';
